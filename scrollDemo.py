...
setBackgroundImage( [  ["dungeonFloor.png", "dungeonFloor.png"] ,
                       ["dungeonFloor.png", "dungeonFloor.png"]  ])


testSprite  = makeSprite("#the animated character",32)  # links.gif contains 32 separate frames of animation. Sizes are automatically calculated.
